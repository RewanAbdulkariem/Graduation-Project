...
class MainWindow(QMainWindow):
    ...
    def on_tab_changed(self, index):
        ...
        self.tabIndex = index
        self.video_thread.setCurrentTabIndex(index)
        self.decide_model()
    ...
    def decide_model(self):
        ...
        self.video_thread.selected_model = selected_model
    ...
    def openFile(self):
            ...
            if fileName:
                self.video_thread.video_path = fileName
                self.start_video_processing()

    def openCamera(self):
        """Open the default camera for video capture."""
        self.video_thread.video_path = None
        self.start_video_processing()
...
class VideoThread(QThread):
    ...
    def __init__(self, video_path=None, selected_model='Vest and Helmet Detection'):
        super().__init__()
    ...
    def prediction(self, frame):
        ...
        elif self.selected_model == 'Vest and Helmet Detection':
            pass
    ...
    def get_model_path(self):
            print("change model: ", self.selected_model)
